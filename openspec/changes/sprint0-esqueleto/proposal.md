...
- Despliegue: API en Railway (Docker), web en Vercel, base en Neon; deploy automático de la rama `main`.
...
- Sistemas externos que requieren cuentas creadas por Franco: GitHub (repositorio privado), Firebase, Neon, Railway, Vercel.
- Herramientas faltantes en la máquina de desarrollo: Flutter SDK y Android Studio.
